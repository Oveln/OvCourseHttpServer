...
use crate::{models::course::{Course, CreateCourse, UpdateCourse}, errors::MyError};
...
pub async fn update_course_details_db(pool: &PgPool, teacher_id: i32, course_id: i32, update_course: UpdateCourse)
